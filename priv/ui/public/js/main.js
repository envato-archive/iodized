...
/***/ function(module, exports, __webpack_require__) {
	...
	var Switchery = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var React = __webpack_require__(4);
	var FeatureForm = __webpack_require__(6);
	var FeatureList = __webpack_require__(7);
	...
	var FeatureBox = React.createClass({displayName: 'FeatureBox',
	  ...
	  render: function() {
	    return (
	      React.DOM.div({className: "featureBox"}, 
	        React.DOM.h2(null, "Features"), 
	          React.DOM.div({className: "new-feature"}, 
...
/***/ function(module, exports, __webpack_require__) {
	...
	require.alias("switchery/switchery.js", "switchery/index.js");if (true) {
	  ...
	  render: function() {
	    ...
	    return (
	        React.DOM.div({className: "new-feature__content"}, 
	            ...
	            React.DOM.form({className: "featureEditForm", ref: "form", role: "form"}, 
	                React.DOM.div({className: "form-group"}, 
	                    React.DOM.label({className: "control-label", htmlFor: "featureTitleInput"}, "Feature Name*"), 
	                    React.DOM.input({type: "text", className: "form-control input-lg", ref: "title", id: "featureTitleInput", onChange: this.handleChange}), 
	                ...
	                React.DOM.div({className: "form-group"}, 
	                    ...
	                    React.DOM.textarea({className: "form-control input-lg", ref: "description", rows: "3", id: "featureDescriptionInput", onChange: this.handleChange}), 
	                ...
	                React.DOM.div({className: "form-group"}, 
	                    React.DOM.label({htmlFor: "featureMasterSwitchStateInput"}, "Master Switch"), 
	                    React.DOM.select({id: "featureMasterSwitchStateInput", value: feature.master_switch_state, className: "form-control", ref: "master_switch_state", onChange: this.handleChange}, 
	                        React.DOM.option({value: "dynamic"}, "Dynamic"), 
	                        React.DOM.option({value: "on"}, "On"), 
	                        React.DOM.option({value: "off"}, "Off")
	                    )
	                ), 
	                React.DOM.button({type: "submit", className: "btn btn-default btn-lg new-feature__submit", onClick: this.handleSaveFeature}, "Add feature toggle")
	            )
	        )
	//old:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FeatureList = React.createClass({displayName: 'FeatureList',
	  render: function() {
	    ...
	    return (
	      React.DOM.div({className: "featureList"}, featureNodes)
	    );
	  }
	});
	      ...
	      React.DOM.div({className: this.switchState('feature')}, 
	          React.DOM.div({className: "feature__view"}, 
	              ...
	              React.DOM.div({className: "feature__switch"}, 
	                  React.DOM.input({type: "checkbox", checked: this.switchState('checkbox'), className: "js-switch", onChange: this.handleToggle})
	              )
	          ), 
	          React.DOM.div({className: "feature__edit"}, 
	              React.DOM.form({className: "featureEditForm", ref: "form", role: "form"}, 
	                  ...
	                  React.DOM.button({className: "btn btn-default btn-lg pull-right", onClick: this.handleUpdate, type: "submit"}, "Update Feature")
	              )
	          )
	      )
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var accumulate = __webpack_require__(137);
